    ...
    <div class="card">
      ...
      >
        <div class="card-body">
          ...
          <p class="mb-0"><strong>เรื่อง: ขอโอนย้ายสาขาวิชาต่างคณะ</strong></p>
          <p class="mb-0"><strong>เรียน คณบดีคณะ(คณะใหม่): </strong>{{ data.to }}</p>
          ...
          <p class="mb-0"><strong>มีความประสงค์จะขอโอนย้ายไปสาขาวิชา: </strong>{{ data.subject }}</p>
          <p class="mb-0"><strong>เนื่องจาก: </strong>{{ data.subject1 }}</p>
